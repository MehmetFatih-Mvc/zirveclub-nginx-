...
function updateTaskProgress(user, actionType) {
    ...
    if (currentTask) {
        ...
        if (currentTask.progress >= currentTask.target && !currentTask.completed) {
            ...
            // Kazanç hesaplama - her görevde bir önceki görevin 1.5 katı
            if (currentTask.id === 1) {
                ...
                // Diğer görevler için bir önceki görevin 1.5 katı
                ...
                if (previousTask && previousTask.completed) {
                    ...
                    if (previousTask.id === 1) {
                        ...
                        if (prevPrevTask && prevPrevTask.completed) {
                            if (prevPrevTask.id === 1) {
                                previousReward = 10 * 1.5; // İkinci görev için
                            } else {
                    ...
                    const currentReward = previousReward * 1.5;
                    user.balance += currentReward;
                    reward += currentReward;
                    console.log(`${user.username} kullanıcısı ${currentTask.id}. görev için ${currentReward} POZI kazandı (Önceki: ${previousReward} × 1.5)`);
                } else {
