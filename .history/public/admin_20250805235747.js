...
async function handleUpdateBtcAddress() {
    ...
    try {
        ...
        const response = await fetch('/api/admin/update-btc-address', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
...
async function handleWithdrawalAction(requestId, action) {
    try {
        ...
        const response = await fetch(`/api/admin/withdrawal/${requestId}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'session-id': adminSessionId
...
async function setPoziAmount(userId, username) {
    ...
    try {
        ...
        const response = await fetch('/api/admin/set-pozi-amount', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'session-id': adminSessionId
